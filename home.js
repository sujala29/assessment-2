...
// Please uncomment the below code  and check
...
function canWeDeliver(inPutZipcode){
    let isZipcodeInArray = false;
    deliveryAreaZipCodes.forEach((zipCode)=>{
        if(zipCode==inPutZipcode){
            isZipcodeInArray = true;
            return}
        })
if (isZipcodeInArray){
...
console.log(canWeDeliver(80009))
...
function canWeDeliverTwo(inPutZipcode){
    let isZipcodeInArray = false;
    isZipcodeInArray = deliveryAreaZipCodes.includes(inPutZipcode)
    if (isZipcodeInArray) {
        return'You are in delivery zone!'}
        else {
            return 'Sorry, we cant deliverto that address'
        }
    }

    console.log(canWeDeliverTwo(85205))
    console.log(canWeDeliverTwo(30001))
...
// --------------------------------------------------------------------
// const lastDealIndex = deals.findIndex((deal) => deal.desc === '   This deal lasts until the end of March! '
// )
// console.log(lastDealIndex)
// if (lastDealIndex !== -1)
//     deals[lastDealIndex] =  {
//         title: 'Free Kids Meal with 2 Regular Entrees', 
//         desc: '   This deal lasts until the end of April! '
//     }
//     console.log(deals)
//     console.log(deals[lastDealIndex])