...
const employeeOne = new Employee("Sujala ","Day Shift");
...
//CODE HERE
const empOne = new Employee("Sujala ","Day Shift");
empOne.getSchedule();
...
//CODE HERE
const manager = new Manager("Sujala ","weekday mornings",["cece","schmidt"]);
